                    ...
                    <form class="form-horizontal form-label-left input_mask" method="post" id="upd" name="upd">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                               <select class="form-control" name="responsable_id" required id="mod_user_id">
                                    <option selected="true" >holis</option>
                                      <?php foreach($users as $p):?>
                                        <option <?php   ?> value="<?php echo $p['id']; ?>"><?php echo $p['name']; ?></option>
                                      <?php endforeach; ?>
                                </select>
