            ...
            <table class="table table-striped jambo_table bulk_action">
                ...
                ?>
                    ...
                    <tr class="even pointer">
                        ...
                        <a href="#" class='btn btn-default' title='Editar actividad' onclick="obtener_datos('<?php echo $id;?>');" data-toggle="modal" data-target=".bs-example-modal-lg-udp"><i class="glyphicon glyphicon-edit"></i></a> 
