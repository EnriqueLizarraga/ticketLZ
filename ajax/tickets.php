            ...
            <table class="table table-striped jambo_table bulk_action">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title">Reponsable </th>
                ...
                <?php 
                        while ($r=mysqli_fetch_array($query)) {
                            ...
                            $sql = mysqli_query($con, "select * from user where id=$responsable_id");
                            if($c=mysqli_fetch_array($sql)) {
                                $name_responsable=$c['name'];
                            }   
                ...
                ?>
                    ...
                    <input type="hidden" value="<?php echo $responsable_id;?>" id="responsable_id<?php echo $id;?>">
                    ...
                    <tr class="even pointer">
                        ...
                        <td><?php echo $name_responsable; ?></td>
